...
func TestGet(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/fwaas/firewalls/fb5b5315-64f6-4ea3-8e58-981cc37c6f61", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "GET")
		th.TestHeader(t, r, "X-Auth-Token", fake.TokenID)
...
func TestDelete(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/fwaas/firewalls/4ec89087-d057-4e2c-911f-60a3b47ee304", func(w http.ResponseWriter, r *http.Request) {
